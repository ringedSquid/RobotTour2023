...
#define MOTOR_INTERVAL_US (uint32_t)35*pow(10, 3)
#define TICKS_PER_REV 651

//ODOMETRY TUNING VALUES
#define ODOMETRY_INTERVAL_US (uint32_t)80*pow(10, 3)
#define STARTING_POSE Vector3d(0, 0, 0)
#define STARTING_THETA 0

//PURE PURSUIT TUNING VALUES
//in mm
#define PURE_PURSUIT_LOOKAHEAD 80
#define PURE_PURSUIT_KP 0.8
#define PURE_PURSUIT_MAX_AV 1.5
#define PURE_PURSUIT_INTERVAL_US (uint32_t)20*pow(10, 3)
